...
// shape
const kRoundBorderShape = RoundedRectangleBorder(
...
const kPrimaryFontStyle = TextStyle(
    fontWeight: FontWeight.bold, color: kPrimaryColor, fontSize: 19.0);
const kDialogTitleStyle = TextStyle(
    fontSize: 22.0, color: kPrimaryColor, fontWeight: FontWeight.w900);
const kDefaultDialogButtonStyle =
    TextStyle(fontSize: 19.0, color: kPrimaryColor);
